...
const WhyUS = ({ techname, description }) => {
    return (
        <section className="min-h-fit rounded-xl  mb-4 pt-10  ">
            <Container>
            <div className="">
                <div className="text-center ">
                    <h3 className="text-xl md:text-3xl lg:text-4xl font-bold leading-tight text-zinc-900  xl:text-4xl font-pj mt-2 md:mt-5 mb-10">Why choose Triosphere for {techname} Development</h3>
                    {/* <p className="text-xs md:text-lg leading-7 text-zinc-800 font-semibold mt-2 md:mt-5 mb-10">{description}</p> */}
                </div>

                <div className="grid grid-cols-1  text-center  md:grid-cols-2 sm:gap-x-12 gap-y-12 lg:grid-cols-3 md:gap-0 ">
                    <div className="md:p-8 lg:p-14">
                        ...
                        <h3 className="mt-12 text-md lg:text-xl font-bold text-zinc-900 font-pj">3+ Years of Experience Developers</h3>
                        <p className="mt-5 textsm lg:text-base text-zinc-600 font-pj">Our developers, engineers, programmers, coders, architects, and consultants have 3+ years of experience.</p>
                    </div>

                    <div className="md:p-8 lg:p-14 lg:border-l lg:border-zinc-200">
                        <svg className="mx-auto" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 className="mt-12 text-md lg:text-xl font-bold text-zinc-900 font-pj">Integrity and Transparency</h3>
                        <p className="mt-5 textsm lg:text-base text-zinc-600 font-pj">Your idea is safe with us as we respect your secrecy. Our team will work with you transparently and follow strict NDAs.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 lg:border-l lg:border-zinc-200">
                        ...
                        <h3 className="mt-12 text-xl font-bold text-zinc-900 font-pj">Free No Obligation Quote</h3>
                        <p className="mt-5 text-base text-zinc-600 font-pj"> Once you share your project details, we will provide you with a no-cost estimation within 24 working hours.</p>
                    </div>

                    <div className="md:p-8 lg:p-14 lg:border-t lg:border-zinc-200">
                        <svg className="mx-auto" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                        ...
                        <h3 className="mt-12 text-md lg:text-xl font-bold text-zinc-900 font-pj">Hassle-Free Project Management</h3>
                        <p className="mt-5 textsm lg:text-base text-zinc-600 font-pj">We keep you relieved of complex project management issues as our experienced project manager works on your project.</p>
                    </div>

                    <div className="md:p-8 lg:p-14 lg:border-l lg:border-zinc-200 lg:border-t">
                        ...
                        <h3 className="mt-12 text-md lg:text-xl font-bold text-zinc-900 font-pj">Quality Coding</h3>
                        <p className="mt-5 textsm lg:text-base text-zinc-600 font-pj">We follow industry best practices and coding standards to ensure high-quality code that is maintainable and scalable.</p>
                    </div>
                    ...
                    <div className="md:p-8 lg:p-14 lg:border-l lg:border-zinc-200 lg:border-t">
                        ...
                        <h3 className="mt-12 text-md lg:text-xl font-bold text-zinc-900 font-pj">100% Code Ownership</h3>
                        <p className="mt-5 textsm lg:text-base text-zinc-600 font-pj">You own the code we develop for you, ensuring complete control and flexibility for your project.</p>
                    </div>
                </div>
            </div>
            </Container>
